...
def swap_pages(input_pdf: PdfFileReader, pdf_writer: PdfFileWriter):
    ...
    # if pgn - numPages == 0, there are 3 more pages past a multiple of 4 -- insert an empty page then swap 2 and 3
    ...
    if diff == 2:
        ...
        # insert blank page b/w last 2 pages so that they will be back to back on final printed copy
